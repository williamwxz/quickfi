...
CREATE TABLE IF NOT EXISTS policies (
  id SERIAL PRIMARY KEY,
  chain_id INTEGER NOT NULL,
  address VARCHAR(42) NOT NULL, -- On-chain policy token address
...
VALUES
  (1337, '0x8B5CF6696FbFc30B7a8ABCB8E4E1cb73416Ed96b', '0x1ED73f28Ac77daBaC2526985062393571A1E73fB', 'POL-123456', 'MetLife', 'Life', 100000, '2026-05-20 00:00:00+00', '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', 'active'),
  (1337, '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0', '0x1ED73f28Ac77daBaC2526985062393571A1E73fB', 'POL-789012', 'Prudential', 'Health', 50000, '2025-12-10 00:00:00+00', '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890', 'used_as_collateral'),
  (1337, '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9', '0x1ED73f28Ac77daBaC2526985062393571A1E73fB', 'POL-345678', 'New York Life', 'Property', 75000, '2027-03-15 00:00:00+00', '0x7890abcdef1234567890abcdef1234567890abcdef1234567890abcdef123456', 'active');

-- Add sample loan (using chain_id 1337 for localhost)
INSERT INTO loans (chain_id, address, borrower_address, collateral_address, loan_amount, interest_rate, term_days, start_date, end_date, status)
VALUES
  (1337, '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9', '0x1ED73f28Ac77daBaC2526985062393571A1E73fB', '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0', 25000, 7.5, 90, '2025-02-15 00:00:00+00', '2025-05-15 00:00:00+00', 'active');
